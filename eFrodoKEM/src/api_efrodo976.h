...
int crypto_kem_keypair_eFrodo976(unsigned char* pk, unsigned char* sk);
int crypto_kem_enc_eFrodo976(unsigned char* ct, unsigned char* ss, const unsigned char* pk);
