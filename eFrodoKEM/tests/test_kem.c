...
*
* Abstract: benchmarking/testing ephemeral KEM scheme
*********************************************************************************************/
...
static int kem_test(const char *named_parameters, int iterations) 
{
    ...
    uint8_t Fin[CRYPTO_CIPHERTEXTBYTES + CRYPTO_BYTES];
        ...
        if (!RUNNING_ON_VALGRIND) {
            ...
            fprintf(stderr, "valgrind efrodo640/test_KEM (or efrodo976 or efrodo1344)\n");
            exit(1);
        }
    #endif
    ...
    printf("\n");
    printf("=======================================================================================================================================\n");
    printf("Testing correctness of ephemeral key encapsulation mechanism (KEM), system %s, tests for %d iterations\n", named_parameters, iterations);
    printf("=======================================================================================================================================\n");

    for (int i = 0; i < iterations; i++) {
        if (crypto_kem_keypair_enc(ct, ss_encap, pk, sk) != 0) {
